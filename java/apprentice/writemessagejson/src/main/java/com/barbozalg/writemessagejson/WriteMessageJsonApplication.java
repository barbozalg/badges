 ...
 *
 * Assignment:
 * two different classes that write a message to a file, one in JSON, one in line-oriented text,
...
public class WriteMessageJsonApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(WriteMessageJsonApplication.class, args);
	}
	...
	public void run(String... args) {
		...
		WriteJsonFile jsonFile = new WriteJsonFile();
		jsonFile.create(listOfEmployees);
